...
// ─── AUCTION BUILDER ──────────────────────────────────────────────────────────
function AuctionBuilder({ members, auctionSessions, setAuctionSessions, auctionTemplates, setAuctionTemplates, showToast }) {
...
// ─── CSV IMPORT ───────────────────────────────────────────────────────────────
function ImportPage({ members, setMembers, showToast }) {
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const saveData = async () => {
      try {
        await setDoc(doc(db, "guilddata", "main"), {
          members, events, attendance, performance, absences, parties, eoRatings, auctionSessions, auctionTemplates
        });
      } catch (err) {
